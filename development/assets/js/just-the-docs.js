...
function initSearch() {
  ...
  request.open('GET', '/hf-isf15acp4-driver/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-isf15acp4-driver/development/assets/css/just-the-docs-' + theme + '.css');
}
